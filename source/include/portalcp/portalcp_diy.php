...
if (submitcheck('uploadsubmit')) {
	...
	$tpldirectory = str_replace('./','',$tpldirectory);
		if($optype == 'canceldiy') {
		@unlink('saekv://data/diy/'.$tpldirectory.'/'.$targettplname.'_diy_preview.htm');
		if($targettplname == $template) @unlink('saekv://data/diy/'.$tpldirectory.'/'.$targettplname.'_'.$clonefile.'_diy_preview.htm');
