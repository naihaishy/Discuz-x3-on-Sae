...
class discuz_memory extends discuz_base
{
	...
	public function __construct() {
		$this->extension['redis'] = false;
		$this->extension['memcache'] = true;
		$this->extension['apc'] = false;
		$this->extension['xcache'] = false;
		$this->extension['eaccelerator'] = false;
		$this->extension['wincache'] = false;
	}
