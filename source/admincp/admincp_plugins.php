...
if(!$operation) {
	...
	if($modules['extra']['langexists'] && file_exists($file = 'saekv://data/plugindata/'.$pluginarray['plugin']['identifier'].'.lang.php')) {
		include $file;
	...
	if(!submitcheck('editsubmit')) {
		...
		if($type == 'common') {
			...
			if($_GET['langexists'] && !file_exists($langfile = 'saekv://data/plugindata/'.$identifiernew.'.lang.php')) {
